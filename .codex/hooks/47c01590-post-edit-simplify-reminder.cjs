// AUTO-GENERATED by takumi — DO NOT EDIT
// Codex hook compatibility wrapper for:
//   /home/pham.van.hung@sun-asterisk.com/projects/demo/nestjs-tutorial/.codex/hooks/post-edit-simplify-reminder.cjs
//
...
// To regenerate: run `tkm init -a codex` again.

"use strict";

const { spawnSync } = require("node:child_process");

const ORIGINAL_HOOK = "/home/pham.van.hung@sun-asterisk.com/projects/demo/nestjs-tutorial/.codex/hooks/post-edit-simplify-reminder.cjs";
...
const SCRUB_RULES = {"PreToolUse":{"deleteFields":[],"allowedPermissionValues":["deny","allow","block"]},"PermissionRequest":{"deleteFields":["additionalContext"],"allowedPermissionValues":null},"Stop":{"deleteFields":["additionalContext"],"allowedPermissionValues":null},"SubagentStop":{"deleteFields":["additionalContext"],"allowedPermissionValues":null}};
