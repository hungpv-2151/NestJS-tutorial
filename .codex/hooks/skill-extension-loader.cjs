 ...
 *   1. Local (personal):  <root>/.codex/skills/<dir>/extensions/*.md
...
try {
   ...
   * <root>/.codex/skills/<dir>/extensions/ exists wins. Each candidate is
  ...
  function resolveLocalExtDir(skillDir, roots) {
    ...
    for (const root of roots) {
      ...
      // Path-traversal guard: a crafted skill name with "../" must not escape .codex/skills/
