...
export class UsersController {
  ...
  @Post('users/login') login(@Req() request: Request, @Body() body: LoginUserDto) { this.throttle.check('login', request.socket.remoteAddress ?? 'unknown', body.user.email); return this.users.login(body.user.email, body.user.password); }
